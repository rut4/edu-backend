...
class ReviewCollectionTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testReturnsAverangeRatingEqualsRealAverangeRating()
    {
        ...
        $this->assertEquals(0, $reviewCollection->getAverageRating($product));
        ...
        $this->assertEquals(4, $reviewCollection->getAverageRating($product));
    }
    ...
    public function testGivenProductBelongsReturnsReviews()
    {
        ...
        $this->assertEquals($expected1, $reviewCollection->reviewsBelongProduct($product1));
        $this->assertEquals($expected2, $reviewCollection->reviewsBelongProduct($product2));
